(function ($) {
	...
	$(filters).click(function(){
		...
		if($(this).data('set')==="all"){
			$('.shop-product-wrap .col-md-4').fadeIn(400);
		}else{
			$('.shop-product-wrap .col-md-4').fadeOut(400);
			$($(this).data('set')).delay(350).fadeIn(400);
			
		}
    });
	let smFilter=$('.sm-filter');
	$(smFilter).click(function(){
		$('.sm-filt-cont').slideToggle(400);
	});
